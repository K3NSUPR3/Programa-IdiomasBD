...
<head>
    <meta charset="utf-8">
    <title>PolyGlob</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Php" name="keywords">
    <meta content="Precios" name="description">
...
<body>
                ...
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="http://cleitmorelia.mx/organigrama/docentes" class="dropdown-item">Nuestro equipo</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            ...
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="https://www.amazon.es/gp/product/8425425018/ref=as_li_ss_tl?ie=UTF8&camp=3626&creative=24822&creativeASIN=8425425018&linkCode=as2&tag=alemansencillolibros-21">Inicio\</a></p>
            ...
            <div class="row">
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="img/BanderaenPines.jpg" style="object-fit: cover;">
                    </div>
                </div>
                        ...
                        <div class="owl-carousel pricing-carousel">
                            <div class="bg-white">
                                ...
                                <div class="p-4">
                                    ...
                                    <p><i class="fa fa-times text-danger mr-2"></i>Aléman</p>
                                    <p><i class="fa fa-check text-success mr-2"></i>Inglés</p>
                                    <p><i class="fa fa-times text-danger mr-2"></i>Ruso</p>
                                    <p><i class="fa fa-times text-danger mr-2"></i>Italiano</p>
                                    <a href="service.php" class="btn btn-primary my-2">Inscribirse</a>
                                <!--Una referencia a inscripcion de base INSCRIP1-->
                                </div>
                            </div>
                            <div class="bg-white">
                                <div class="d-flex align-items-center justify-content-between border-bottom border-primary p-4">
                            ...
                            <div class="bg-white">
                                ...
                                <div class="p-4">
                                    <p><i class="fa fa-check text-success mr-2"></i>Frances</p>
                                    <p><i class="fa fa-check text-success mr-2"></i>Aléman</p>
                                    <p><i class="fa fa-check text-success mr-2"></i>Inglés</p>
                                    <p><i class="fa fa-check text-success mr-2"></i>Ruso</p>
                                    <p><i class="fa fa-check text-success mr-2"></i>Italiano</p>
                                    <a href="service.php" class="btn btn-primary my-2">Inscribirse</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="img/ChicaCafeIdiomas.jpeg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="hours-text bg-light p-4 p-lg-5 my-lg-5">
                        <h6 class="d-inline-block text-white text-uppercase bg-primary py-1 px-2">Horarios</h6>
                        <h1 class="mb-4">Tu mejor opcion para aprender idiomas</h1>
                        <p>Nuestros hararios</p>
                            ...
                            <div class="w-100">
                                <div class="input-group">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary px-4" title='para decir hola mundo' onclick="mostrarAlerta()">Click</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script> function mostrarAlerta() { alert('Hola, Mundo'); } </script>
