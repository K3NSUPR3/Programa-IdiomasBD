...
<head>
    ...
    <meta content="opening" name="keywords">
                ...
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="opening.php" class="dropdown-item active">Horarios</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="hours-text bg-light p-4 p-lg-5 my-lg-5">
                        ...
                        <ul class="list-inline">
                            <li class="h6 py-1"><i class="far fa-circle text-primary mr-3"></i>Lunes – Virnes : 9:00 AM - 7:00 PM</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pl-lg-5">
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-5">
                            <h5 class="text-white text-uppercase mb-4">Nuestro servicio</h5>
                            <div class="d-flex flex-column justify-content-start">
