...
<head>
    ...
    <meta content="NOVA" name="keywords">
    <meta content="Nova" name="description">
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                <a href="https://shop.cambridge.org/english/product/2800506028" class="btn btn-primary d-none d-lg-block">Libro</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
    ...
    <div class="container-fluid px-0 py-5 my-5">
        <div class="row mx-0 justify-content-center text-center">
            <div class="col-lg-6">
                ...
                <h1>Servicios de idiomas</h1>
            </div>
        </div>
        <div class="owl-carousel service-carousel">
            <div class="service-item position-relative">
                <img class="img-fluid" src="img/Flag_of_Russia.png" alt="">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="img/FlagItaly.png" alt="">
                <div class="service-text text-center">
                    <h4 class="text-white font-weight-medium px-3">Acerca de Italia</h4>
                    <p class="text-white px-3 mb-3">La Universidad de Bolonia, fundada en 1088, es considerada la universidad más antigua del mundo</p>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="https://www.britannica.com/place/Italy">ver</a>
                    </div>
                </div>
            </div>
            <div class="service-item position-relative">
                ...
                <div class="p-5 my-5" style="background: rgba(33, 30, 28, 0.7);">
                    ...
                    <form action="registrarInscripcion.php" method="POST">
                        <div class="form-row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control bg-transparent p-4" name="nombre" placeholder="Tu nombre" required="required" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="email" class="form-control bg-transparent p-4" name="mail" placeholder="Correo Eléctronico" required="required" />
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="date" id="date" data-target-input="nearest">
                                        <input type="text" class="form-control bg-transparent p-4 datetimepicker-input" placeholder="Selecciona Fecha" data-target="#date" name="fecha" data-toggle="datetimepicker"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="time" id="time" data-target-input="nearest">
                                        <input type="text" class="form-control bg-transparent p-4 datetimepicker-input" placeholder="Selecciona Horario" data-target="#time" name="horario" data-toggle="datetimepicker"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <select id="formulario" class="custom-select bg-transparent px-4" name="SIdioma" style="height: 47px;">
                                        <option value="" disable selected>Selecciona un idioma</option>
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ml-3">
                                    <h6 class="text-uppercase">Elena Montes</h6>
                                    <span>Estudiante de Mecidina</span>
                                </div>
                            </div>
                            <p class="m-0">Gracias a los cursos que recibí en PolyGlob he podido ir a ejercer mi profesion favorita en el extranjero.</p>
                        </div>
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute" style="top: -6px; right: 0;"></i>
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ml-3">
                                    <h6 class="text-uppercase">Sofía Delgado</h6>
                                    <span>Arquitecta</span>
                                </div>
                            </div>
                            <p class="m-0">He podido complementar mi conocimiento en otros idiomas y ahora puedo ejercer diversos cursos. ¡Muchas Gracias!.</p>
                        </div>
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute" style="top: -6px; right: 0;"></i>
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ml-3">
                                    <h6 class="text-uppercase">Marta Saucedo</h6>
                                    <span>Militar</span>
                                </div>
                            </div>
                            <p class="m-0">Quiero expresar mis agradecimientos por la increible labor que realizan. Gracias a sus recursos y herramientas, he podido mejorar significativamente mis habilidades</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="w-100">
                                <div class="input-group">
                                    <div class="input-group-append">
                                       <p>La base de datos ha sido actualizada</p>
                                    </div>
                                </div>
                            </div>
                        </div>
