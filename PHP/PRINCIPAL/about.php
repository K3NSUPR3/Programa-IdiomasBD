...
<head>
    ...
    <meta content="ken rene jose" name="description">
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">Tu mejor lugar de aprendizaje</h1>
                    <p class="pl-4 border-left border-primary">Con nosotros aprenderas si o que</p>
                    <div class="row pt-3">
                        <div class="col-6">
                            <div class="bg-light text-center p-4">
                                <h3 class="display-4 text-primary" data-toggle="counter-up">17,348</h3>
                        ...
                        <div class="col-6">
                            <div class="bg-light text-center p-4">
                                ...
                                <h6 class="text-uppercase">Hablantes Egresados Oficialmente</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="team position-relative overflow-hidden mb-5">
                        ...
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
                                ...
                                <p class="m-0">Nunca es demasiado tarde para brillar</p>
                            </div>
                    ...
                    <div class="team position-relative overflow-hidden mb-5">
                        ...
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
                                ...
                                <p class="m-0">Cree en ti y todo será posible.</p>
                            </div>
                            <div class="team-social bg-dark text-center">
                                <a class="btn btn-outline-primary btn-square mr-2" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-outline-primary btn-square mr-2" href="#"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="team position-relative overflow-hidden mb-5">
                        ...
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
                                ...
                                <p class="m-0">La felicidad no es una meta, es un camino.</p>
                            </div>
                            <div class="team-social bg-dark text-center">
                                <a class="btn btn-outline-primary btn-square mr-2" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-outline-primary btn-square mr-2" href="#"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        ...
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
                                <h5 class="text-white text-uppercase">Kelly W.</h5>
                                <p class="m-0">El éxito es la suma de pequeños esfuerzos </p>
                            </div>
                            <div class="team-social bg-dark text-center">
                                <a class="btn btn-outline-primary btn-square mr-2" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-outline-primary btn-square mr-2" href="#"><i class="fab fa-facebook-f"></i></a>
